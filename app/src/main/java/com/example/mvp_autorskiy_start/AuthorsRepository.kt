...
import com.example.mvp_autorskiy_start.utils.ResourceMapper
...
object AuthorsRepository {
    ...
    private data class WorkJson(
        ...
        fun toWork(authorName: String): Work = Work(
            ...
            summary = summary,
            fullText = fullText,
            arguments = arguments.map { it.toArgument(authorName, title) } // передаём автора и название произведения
        )
    }
