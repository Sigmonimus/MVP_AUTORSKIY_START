...
class WorkArgumentsFragment : Fragment() {

    private var _binding: FragmentWorkArgumentsBinding? = null
    private val binding get() = _binding!!

    private var argumentList: List<Argument> = emptyList()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        argumentList = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
    ...
    companion object {
        fun newInstance(arguments: List<Argument>): WorkArgumentsFragment {
            val fragment = WorkArgumentsFragment()
            val args = Bundle()
